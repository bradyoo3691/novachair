...
export const PRODUCTS: Product[] = [
  {
    ...
    wholesaleMinQty: 5,
    description: '인체공학적 설계로 장시간 업무에 최적화된 프리미엄 오피스 체어입니다. 메시 백레스트와 조절 가능한 요추 지지대로 척추 건강을 보호합니다.',
    shortDesc: '인체공학 메시 오피스 체어',
    image: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663474293513/N58bZLfHdioH99RE25RZcN/product-office-chair-RjoBSg9ST8YyF76qJMvTiZ.webp',
    images: [
      'https://d2xsxph8kpxj0f.cloudfront.net/310519663474293513/N58bZLfHdioH99RE25RZcN/product-office-chair-RjoBSg9ST8YyF76qJMvTiZ.webp',
    ],
    badge: 'best',
    stock: 48,
    specs: {
